...
RUN dpkg --add-architecture i386 && apt-get update && apt-get install -y wget git curl zip lib32z1 libstdc++6:i386 libsdl1.2debian:i386 libgl1:i386 qemu-kvm kmod && rm -rf /var/lib/apt/lists/*
